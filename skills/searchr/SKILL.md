...
State what evidence, condition, or counterexample could change the answer. Build the search frame from the resulting premise check.
...
Form the next query around the strongest lead or relationship. Rank leads by their potential to alter the conclusion, expose an assumption, reach closer evidence, or resolve a consequential contradiction. Give low priority to generic restatements and repeated summaries.
...
Converge when the answer is stable across independent evidence, new searches mostly repeat known claims, remaining uncertainty exceeds available evidence, or further research cannot change the conclusion enough to justify its cost. Classify the result by evidential status and state the remaining uncertainty.

...
apt-get update
apt-get install -yq apt-transport-https rsync software-properties-common sshpass tmux vim autossh bash-completion git jq file tree ffmpeg ripgrep cmake unzip acl rustfmt rustc cargo build-essential pkg-config

...
alias PUSH4="git pull >/dev/null && git add -A && git commit -mPUSH --no-verify && git push --no-verify"
alias PUSH="git add -A && git commit -mPUSH --no-verify && git pull -X ours --no-verify && git push --no-verify"

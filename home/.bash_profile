...
alias UUU=' sudo systemctl restart systemd-timesyncd ; sudo npm install -g npm ; sudo npm install -g @openai/codex ; sudo agy update ; udo apt update && sudo apt install claude-code -y ' # ; hermes update -y  ;  gcloud components update '

...
touch ~/.hushlogin
alias CDGG2=' DEV=$(blkid -L g) && mountpoint -q /g || sudo mount -o defaults,noatime,commit=300 $DEV /g ; cd /g ; ls -A --color | sort '
alias CDGG=" DEV=\$(blkid -L g) && mountpoint -q /g || sudo mount -o defaults,noatime,commit=300 \$DEV /g ; cd /g/* 2>/dev/null || { cd /g && ls -A --color |sort ;}"

...
alias .....=' cd ../../../../ '
alias ......=' cd ../../../../../ '
alias CDg=' cd /g ; ls -A --color | sort '
alias CDA=' cd /g/app/ ; ls -l --color '
alias CDN=' cd /g/nf/  ;  ls -l --color '
alias CDT=' cd /g/tools/ ;  ls -l --color '
...
alias DY=' codex --yolo -m gpt-5.5 -c model_reasoning_effort=medium '
...
alias UUU=' sudo npm install -g npm ; sudo npm install -g @openai/codex ' # ; hermes update -y  ; sudo agy update ' # ;  sudo apt update && sudo apt install claude-code -y '
...
AWK() { awk $2 "{print\$$1}" ; }
ECDZ() { echo 'source /dev/stdin <<< "$(curl -Ls https://raw.githubusercontent.com/ernie18a/dotfiles/main/home/.bash_profile)"' |tee ~/.bash_profile ; }
l() { ls -A | grep "^\." | xargs -d '\n' ls -d --color ; }

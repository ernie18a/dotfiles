...
LG() { UV_PROJECT_ENVIRONMENT=/g/.TMP/lg-venv UV_CACHE_DIR=/g/.TMP/uv-cache XDG_CACHE_HOME=/g/.TMP/xdg-cache uv run --project /g/app/langGraph --directory "$PWD" lg-run --config /g/app/langGraph/lg.toml "$@"; }

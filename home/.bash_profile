...
alias .....=' cd ../../../../ '
alias ......=' cd ../../../../../ '
alias CDA=' cd /g/app/ || cd ~/.G/app/ '
alias cds=' cd /g/site/ || cd ~/.G/site/ '
alias CDSI=' cd /g/site/ || cd ~/.G/site/ '
alias CDN=' cd /g/nf/ || cd ~/.G/nf/ '
...
alias ACL=' sudo chown -R :g /g ; sudo chmod -R 2777 /g ; sudo setfacl -R --set u::rwx,g::rwx,o::rwx,m:rwx,d:u::rwx,d:g::rwx,d:o::rwx,d:m:rwx /g ; find /g -name ".git" -type d -exec sudo setfacl -R -m m:rwx {} + '

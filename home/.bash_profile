...
alias UU=' sudo apt update && sudo apt install claude-code -y ; sudo agy update ; sudo npm install -g @openai/codex ' # ; sudo hermes update '
...
alias CDPY=' cd /g/private/yet || cd ~/.G/private '

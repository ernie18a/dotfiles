...
LG2() { UV_PROJECT_ENVIRONMENT=/g/.TMP/lg2-venv UV_CACHE_DIR=/g/.TMP/uv-cache XDG_CACHE_HOME=/g/.TMP/xdg-cache uv run --project /g/app/langGraph --directory "$PWD" python /g/app/lg2/lg2.py "$@"; }
LG() { UV_PROJECT_ENVIRONMENT=/g/.TMP/lg-venv UV_CACHE_DIR=/g/.TMP/uv-cache XDG_CACHE_HOME=/g/.TMP/xdg-cache uv run --project /g/app/langGraph --directory "$PWD" lg-run "$@"; }

...
alias ACL3=' sudo chown -R e:g /g && sudo find /g \( -type d -exec chmod 2770 {} + \) -o \( -type f -exec chmod 660 {} + \) && sudo find /g \( -type d -exec setfacl -m u::rwx,g::rwx,o::-,m::rwx,d:u::rwx,d:g::rwx,d:o::-,d:m::rwx {} + \) -o \( -type f -exec setfacl -m u::rw-,g::rw-,o::-,m::rw- {} + \) '

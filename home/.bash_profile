...
alias OL='codex --dangerously-bypass-approvals-and-sandbox --dangerously-bypass-hook-trust -m gpt-5.6-luna -c model_reasoning_effort=xhigh'
alias OS='codex --dangerously-bypass-approvals-and-sandbox --dangerously-bypass-hook-trust -m gpt-5.6-sol -c model_reasoning_effort=medium'
alias OSL='codex --dangerously-bypass-approvals-and-sandbox --dangerously-bypass-hook-trust -m gpt-5.6-sol -c model_reasoning_effort=low'
alias OT='codex --dangerously-bypass-approvals-and-sandbox --dangerously-bypass-hook-trust -m gpt-5.6-terra -c model_reasoning_effort=high'
alias OR='codex --dangerously-bypass-approvals-and-sandbox --dangerously-bypass-hook-trust resume'
alias co=' cp '
alias cp=' cp -urf '

...
alias OL='codex -m gpt-5.6-luna -c model_reasoning_effort=xhigh'
alias OS='codex -m gpt-5.6-sol -c model_reasoning_effort=medium'
alias OSL='codex -m gpt-5.6-sol -c model_reasoning_effort=low'
alias OT='codex -m gpt-5.6-terra -c model_reasoning_effort=high'
alias OR='codex resume'
alias co=' cp '
alias cp=' cp -urf '
